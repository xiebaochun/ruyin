...
define(function (require) {
    ...
    var Transformable = require('/Public/TyRyBottleInChina/Wx/src/mixin/Transformable');
    var util = require('/Public/TyRyBottleInChina/Wx/src/tool/util');
    var vmlCanvasManager = window['G_vmlCanvasManager'];
    var config = require('/Public/TyRyBottleInChina/Wx/src/config');
