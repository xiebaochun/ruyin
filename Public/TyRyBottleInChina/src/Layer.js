...
define(function (require) {
    ...
    var Transformable = require('/Public/TyRyBottleInChina/src/mixin/Transformable');
    var util = require('/Public/TyRyBottleInChina/src/tool/util');
    var vmlCanvasManager = window['G_vmlCanvasManager'];
    var config = require('/Public/TyRyBottleInChina/src/config');
