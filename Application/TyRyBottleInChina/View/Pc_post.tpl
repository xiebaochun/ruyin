    ...
    <div class="page_post">
        ...
        <div class="page_post_right">
            <p>
                ...
                <i>当前票数:</i><span>{$works['poll']}</span></p>
            <div style="padding-bottom:40px;clear:both;padding-left:145px;">
                ...
                <script type="text/javascript" charset="utf-8">
                    bShare.addEntry({
                        title: "#统一如饮【瓶上中国】#",
                        url:Main.url+'TyRyBottleInChina/Pc/workparticulars/id/'+{$works['id']},
            ...
            <a href="__URL__/{$name}" style="margin-right:10px;"><img src="http://static.sinreweb.com/2015/TyRyBottleInChina/bottle/images/a15_09.png" ></a>
            <a href="__URL__/worklist"><img src="http://static.sinreweb.com/2015/TyRyBottleInChina/bottle/images/a15_15.png" ></a>
        </div>
    </div>
</div>
<script>
