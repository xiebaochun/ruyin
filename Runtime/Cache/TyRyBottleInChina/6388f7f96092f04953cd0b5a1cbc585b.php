    ...
    <div class="page_post">
        ...
        <div class="page_post_right">
            <p>
                ...
                <i>当前票数:</i><span><?php echo ($works['poll']); ?></span>
            </p>
            ...
            <?php if($wtype == 0){ ?>
                <span class="tou_cc" data-id="<?php echo ($works['id']); ?>" data-flag="<?php echo ($user?1:0); ?>" style="float:left;margin-right:10px;">投票</span>
            <?php } ?>
            <a href="/TyRyBottleInChina/Pc/worklist" style="margin-top:10px;"><img src="http://static.sinreweb.com/2015/TyRyBottleInChina/bottle/images/a15_15.png" ></a>
